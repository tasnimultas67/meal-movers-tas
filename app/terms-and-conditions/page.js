...
export const metadata = {
  title: "Terms and Conditions — Meal Movers",
  description:
...
const page = () => {
  return (
    <div className="p-4 bg-themeColor/5 rounded-xl my-20 mb-10 w-11/12 m-auto text-sm">
        ...
        <ul className="space-y-2">
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to test-llc001,
              House#711/7, Road#11, Baitul Aman Housing Society, Shyamoli,
              Dhaka-1207.
            </p>
          </li>
          <li>
