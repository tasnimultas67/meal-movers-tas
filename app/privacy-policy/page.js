...
export const metadata = {
  title: "Privacy Policy — Meal Movers",
  description:
...
const page = () => {
  return (
    <div className="text-sm w-11/12 m-auto bg-themeColor/5 p-4 rounded-xl my-20 mb-10">
        ...
        <ul className="space-y-2">
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Meal Movers.
            </p>
          </li>
          <li>
            <p>
