...
export const metadata = {
  title: "Return and Refund Policy — Meal Movers",
  description:
...
const page = () => {
  return (
    <div className="w-11/12 m-auto my-20 mb-10 p-4 bg-themeColor/5 rounded-lg space-y-3 text-sm">
      <h1 className="text-4xl font-bold">Return and Refund Policy</h1>
      <p>Last updated: January 10, 2025</p>
      <p>Thank you for shopping at Meal Movers.</p>
      <p>
      ...
      <ul className="space-y-2">
        <li>
          <p>
            ...
            this Agreement) refers to Meal Movers.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Meal Movers, accessible from{" "}
            <a
              href="https://mealmovers.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://mealmovers.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul className="space-y-2">
        <li>
          <p>By email: info@mealmovers.vercel.app</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://mealmovers.vercel.app/contact-us"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://mealmovers.vercel.app/contact-us
            </a>
          </p>
        </li>
        <li>
          <p>By phone number: +880012345678910</p>
        </li>
      </ul>
      <p>
      ...
      <p>
        House#711/7, Road#11, Baitul Aman Housing Society, Shyamoli, Dhaka-1207
      </p>
      <p>
