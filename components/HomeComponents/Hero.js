    ...
    <section className="h-screen grid grid-cols-1 md:grid-cols-2 items-center justify-items-center border-b w-11/12 m-auto">
      <div className=" space-y-6 ">
        ...
        <div className="flex items-center">
          <input
            ...
            className="border border-themeColor p-2 text-sm w-8/12 rounded-tl rounded-bl"
          />
          <button className="bg-themeColor p-[0.68rem] rounded-tr rounded-br">
      ...
      <div className="flex items-center justify-center">
        <div className="relative top-0">
          <div className="p-14 bg-themeColor/15 rounded-2xl">
            <Image
              className="size-[20rem] object-cover object-top rounded-2xl shadow-lg"
              width={500}
              height={500}
